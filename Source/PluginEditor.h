...
private:
    ...
    juce::Slider portaSlider, gainSlider, cutoffSlider, resSlider, wtSlider, loopEndSlider;
    juce::Label titleLabel, statusLabel;
    juce::Label startLabel, endLabel, portaLabel, gainLabel, cutoffLabel, resLabel;
    ...
    std::unique_ptr<SliderAttachment> portaAttachment, gainAttachment, cutoffAttachment, resAttachment;
    std::unique_ptr<SliderAttachment> wtAttachment, loopEndAttachment;
    std::unique_ptr<ButtonAttachment> monoAttachment, legatoAttachment;
